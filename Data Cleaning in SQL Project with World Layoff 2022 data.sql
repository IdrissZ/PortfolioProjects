...
-- Creating a staging table. This is the one we will work in and clean the data. We want a table with the raw data as backup
...
-- look at oda company to confirm
SELECT *
FROM world_layoffs.layoffs_staging
WHERE company = 'Oda'
;
-- they are all legitimate entries. We need to really look at every single row to be accurate
...
-- we have some "United States" and some "United States." with a period at the end. Let's fix this.
